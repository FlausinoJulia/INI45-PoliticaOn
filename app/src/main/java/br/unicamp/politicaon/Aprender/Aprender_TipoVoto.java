...
public class Aprender_TipoVoto extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aprender_tipo_voto);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId())
                {
                    ...
                    case R.id.monitorar:
                        ...
                        break;
                    case R.id.inicio:
                        Intent irProInicio = new Intent(Aprender_TipoVoto.this, ActivityInicio.class);
                        irProInicio.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                        startActivity(irProInicio);
                        break;
                    case R.id.conhecer:
                        Intent irProConhecer = new Intent(Aprender_TipoVoto.this, ActivityConhecerCandidatos.class);
