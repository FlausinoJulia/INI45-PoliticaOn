...
public class Aprender_SistemaPolitico extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aprender_sistema_politico);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId())
                {
                    ...
                    case R.id.monitorar:
                        ...
                        break;
                    case R.id.inicio:
                        Intent irProInicio = new Intent(Aprender_SistemaPolitico.this, ActivityInicio.class);
                        irProInicio.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                        startActivity(irProInicio);
                        break;
                    case R.id.conhecer:
                        Intent irProConhecer = new Intent(Aprender_SistemaPolitico.this, ActivityConhecerCandidatos.class);
